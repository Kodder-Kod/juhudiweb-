...
// import routes file
import { DashboardMenuClient } from "../../routes/DashboardroutesClient";

const NavbarVerticalclient = (props) => {
  ...
  return (
    ...
    <Fragment >
      <SimpleBar style={{ maxHeight: "100vh" }}>
        <div className="nav-scroller" style={{ marginTop: 30, }}>
          <Link href="/" className="navbar-brand">

            <Image src="/images/juhudi pic.png" alt="" style={{ width: 200, height: 120, borderRadius: 20 }} />
          </Link>
        </div>
        {/* Dashboard Menu */}
        <Accordion
        ...
        >
          {DashboardMenuClient.map(function (menu, index) {
            if (menu.grouptitle) {
              return (
              ...
              if (menu.children) {
                ...
                return (
                  <Card bsPrefix="nav-item" key={index} style={{ borderWidth: 2, borderColor: "black" }}>
...
export default NavbarVerticalclient;
